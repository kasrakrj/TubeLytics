...
public class SentimentServiceTest {
    ...
    public void testAnalyzeSentimentMockedAvgSentiment() {
        List<Video> videos = List.of(
                new Video("Positive", "I am so happy and amazed!", "Channel", "url1", "id1", "channelId1", "urlv1","2024-02-22"),
                new Video("Negative", "The movie makes me both sad and disappointed.", "Channel", "url2", "id2", "channelId2", "urlv2","2024-02-22"),
                new Video("Neutral", "Just an ordinary, regular book.", "Channel", "url3", "id3", "channelId3", "urlv3","2024-02-22")
        );
    ...
    public void testAnalyzeSentimentMostlyPositive() {
        List<Video> videos = List.of(
                new Video("Positive", "This is so wonderful. I love it.", "Channel", "url1", "id1", "channelId1", "urlv1","2024-02-22"),
                new Video("Positive", "I am thrilled todaaay.", "Channel", "url2", "id2", "channelId2", "urlv2","2024-02-22"),
                new Video("Neutral", "It was just a regular book.", "Channel", "url3", "id3", "channelId3", "urlv3","2024-02-22")
        );
    ...
    public void testAnalyzeSentimentMostlyNegative() {
        List<Video> videos = List.of(
                new Video("Negative", "This makes me sad. I wanna cry.", "Channel", "url1", "id1", "channelId1", "urlv1","2024-02-22"),
                new Video("Negative", "Feeling down and angry.", "Channel", "url2", "id2", "channelId2", "urlv2","2024-02-22"),
                new Video("Neutral", "It's an average amount of profession.", "Channel", "url3", "id3", "channelId3", "urlv3","2024-02-22")
        );
